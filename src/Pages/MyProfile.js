                            ...
                            <CardBody>
                                <CardText style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
                                    <div style={{ display: "flex", justifyContent: "center" }}>
                                        <img src={ProfilePic} style={{ width: "200px", marginTop: "-40px" }} />
                                    </div>
                                    <div style={{ fontWeight: "700", fontSize: "22px", color: "var(--blue-color)", textAlign: "center", marginBottom: "30px" }}>USER NAME</div>
